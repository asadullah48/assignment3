          ...
          <div className={styles.row}>
            <div className={styles.colLeft}>
              <header className={styles.heading}>
                ...
                Online learning has revolutionized education by making knowledge accessible to people anywhere, anytime. It offers flexibility, 
                ...
                online learning caters to diverse interests and needs. Additionally, it promotes self-discipline and independent learning while providing opportunities for interaction through discussion forums, video lectures, and virtual collaboration tools.Excepteur sint occaecat cupidatat non proident, sunt <br /> in
                   <br /> est laborum.
