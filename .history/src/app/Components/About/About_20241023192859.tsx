          ...
          <div className={styles.row}>
            <div className={styles.colLeft}>
              <header className={styles.heading}>
                ...
                it promotes self-discipline and independent learning while providing opportunities for interaction through discussion forums, video lectures, and virtual collaboration tools.Excepteur sint occaecat cupidatat non proident, sunt <br /> in
                   <br /> est laborum.
